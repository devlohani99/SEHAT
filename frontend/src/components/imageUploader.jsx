    ...
    <div className="min-h-screen bg-gray-50 flex items-center">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-white justify-center items-center p-12">
        <div className="relative w-full max-w-lg">
          <img
            src="https://img.freepik.com/free-vector/cartoon-illustration-bank-vault-metallic-iron-safe-door_1441-1915.jpg?t=st=1743100873~exp=1743104473~hmac=cdfe620528750f655b349f452b97b8e66f9b641062d98842502022c652251bf5&w=1380"
