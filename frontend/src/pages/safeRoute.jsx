...
const SafeRoute = () => {
  ...
  const findRoute = useCallback(() => {
    ...
    const tryNextOption = () => {
      if (attemptCount >= routingOptions.length) {
        setLoading(false);
        setError('No safe route found. All routes pass through unsafe areas.');
        return;
      }
  ...
  return (
    <div className="relative bottom-22 h-screen flex flex-col bg-gray-50">
      <Navbar />
      ...
      <div className="flex-1 container mx-auto px-4 py-6">
        <div className="h-full bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-4">
            ...
            <p className="text-blue-100">Find the safest route to your destination</p>
          </div>
